...
void main() {
  runApp(MultiProvider(
    child: MyApp(),
    providers: [
      ChangeNotifierProvider(create: (context) => AppLocaleModel()),
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // We are using consumer here so we can load user preference locale in the beginning.
    return Consumer<AppLocaleModel>(
      builder: (context, model, child) {
        print('Locale: ${model.locale}');
        return MaterialApp(
